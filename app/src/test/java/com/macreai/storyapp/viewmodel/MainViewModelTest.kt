...
import com.macreai.storyapp.DataDummy
import com.macreai.storyapp.MainDispatcherRule
import com.macreai.storyapp.adapter.StoryAdapter
import com.macreai.storyapp.getOrAwaitValue
...
//        val data: PagingData<QuoteResponseItem> = PagingData.from(dummyQuote)
        ...
        val mainViewModel = MainViewModel(userPreferences, storyRepository)
